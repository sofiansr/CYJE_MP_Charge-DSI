...
| :-------- | :------- |
| Prospects total | Simple compteur du nombre de prospects enregistré dans la base de données |
| Prospects contactés ce mois | Compteur du nombre de prospects contacté ce mois (du 1er jusqu'à la fin du mois actuel) |
...
| Status prospects | Graphique en barre récapitulatif de tous les status des prospects de la base de données |
...
| Status | Statut du prospect.</br>Les status possibles sont :</br> 'A contacter', 'Contacté', 'A rappeler', 'Relancé', 'RDV', 'PC', 'Signé', 'PC refusée', 'Perdu' |
...
| Relancé le | Date de la dernière relance de ce prospect, si il à été relancé. |
...
Le bouton "Détails..." de chaque ligne du tableau (chaque prospect) affichera tous les données du prospects (voir colonnes ci-dessus), **ainsi que les champs complémentaires suivants** :
...
Vous pouvez également modifier ou supprimer un utilisateur, en choissisant l'utilisateur dans la liste, puis en cliquant sur le bouton "Modifier".</br>
Le bouton "Modifier" débloquera les champs, vous permettant de les modifier. N'oubliez pas d'enregistrer ou d'annuler vos modifications.</br>
